...
public:
  ...
  // Entrada dos dados de um circuito via teclado       // feito
  // O usuario digita o numero de entradas, saidas e portas     // feito
  // apos o que, se os valores estiverem corretos (>0), redimensiona o circuito     // feito
